...
#### Steps to create a docker-compose.yml file that deploys our web application image

Step 1: Add a file called docker-compose.yaml with the following content to the '[aws-java-maven-app](https://github.com/deepthi-sasi/aws-java-maven-app)' project:
    ...
    stage('Deploy Application') {
        steps {
            script {
                ...
                sshagent(['ec2-server-key']) {
                sh 'scp -o StrictHostKeyChecking=no server-cmds.sh docker-compose.yaml ec2-user@35.156.XX.XX:/home/ec2-user'
